  ...
  e.fn.imageUploader = function (t) {
    let n,
      i = {
        ...
        label: "قم بإسقاط الملفات هنا أو انقر للتحميل.",
        label2: "أرفع حتي 10 صور",
    ...
    let o = function () {
        ...
        let x = e("<div>", { class: "text" }).appendTo(i);
        e("<img/>", {
          src: "/assets/media/svg/files-upload.svg",
        }).appendTo(i),
          e("<span>", { text: a.settings.label }).appendTo(x);
        e("<span>", { text: a.settings.label2 }).appendTo(x);
        return (
